...
const scrollToContent = () => {
  ...
  const contentSection = document.getElementById("web-design-submit");
  if (contentSection) {
...
export default function WebDevelopmentForm() {
    ...
    <>
      <AllProjectItem>
        <Container>
          ...
          >
            web development requirement form
          </Typography>
