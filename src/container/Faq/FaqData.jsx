...
const config = {
  ...
  arrowIcon: "V",
  openOnload: 0,
  expandIcon: <KeyboardArrowUpTwoToneIcon />, // Arrow up icon
  collapseIcon: <KeyboardArrowDownTwoToneIcon/>, // You can use a Unicode character for collapse or another icon
};
...
const FaqData = () => {
  ...
  return (
    <div className="container">
      <div
        style={{ float: "left", width: "50%", textAlign: "left !important" }}
      >
        <Faq
